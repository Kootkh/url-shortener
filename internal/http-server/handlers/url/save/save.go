...
// Описываем поступающие запросы (json объект)
type Request struct {
...
// Описываем возвращаемый ответ (json объект)
...
// Интерфейс стораджа. Описываем по месту использования.
...
// Функция "конструктор" для хэндлера. Возвращает функцию http.HandlerFunc, которая обрабатывает запросы.
func New(log *slog.Logger, urlSaver URLSaver) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Если ошибок нет, то пигем сообщение об успешном сохранении в log.Info
